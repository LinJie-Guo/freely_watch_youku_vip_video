      ...
      function e(t, n, i) {
          ...
          function i(t, n, o) {
            ...
            3 : [function(e, t) {
              ...
              t.exports = {
                init: function() {
                  ...
                  var e = 0,
                  t = function() { (e = ~e) && this.onCommentTimeUpdate(),
                    s(t)
                  }.bind(this);
                  t()
                },
            ...
            4 : [function(e, t) {
              ...
              t.exports = {
                ...
                onfullScreenClick: function() { ["webkitRequestFullScreen", "mozRequestFullScreen", "requestFullScreen"].forEach(function(e) {
            ...
            8 : [function(e, t) {
              ...
              o(i.prototype, {
                ...
                trigger: function(e, t) {
                  ...
                  t.forEach(function(t) { (this._eventMap[e] || []).forEach(function(e) {
                      e[0].call(e[1], t)
                    })
                  }.bind(this))
                }
        ...
        10 : [function(e, t) {
          ...
          function l(e) {
            ...
            o = 0; i > o; ++o) if (n = e[o], "]" == n && (t = !1), "[" == n && (t = !0), "=" == n && !t) return o
          }
          function c(e, t) {
            for (var n = 0,
            i = e.length >> 0,
            o = arguments[2]; i > n;) n in e && (o = t.call(void 0, o, e[n], n, e)),
            ++n;
            return o
          }
          function d(e) {
        ...
        13 : [function(e, t, n) {
          ...
          n.getVideos = function(e, t) {
            ...
            s = function(e) {
              var t, n = [["\u539f\u753b", "http://vr.tudou.com/v2proxy/v2.m3u8?it=" + a + "&st=5"], ["\u8d85\u6e05", "http://vr.tudou.com/v2proxy/v2.m3u8?it=" + a + "&st=4"], ["\u9ad8\u6e05", "http://vr.tudou.com/v2proxy/v2.m3u8?it=" + a + "&st=3"], ["\u6807\u6e05", "http://vr.tudou.com/v2proxy/v2.m3u8?it=" + a + "&st=2"]];
        ...
        14 : [function(e, t, n) {
          ...
          n.parseYoukuCode = function(e, t) {
            u({
              ...
              jsonp: !0,
              callback: function(n) { - 1 == n && console.log("\u89e3\u6790youku\u89c6\u9891\u5730\u5740\u5931\u8d25", 2);
                var c = n.data,
                ...
                if (m.sid = u[0], m.token = u[1], d) {
                  ...
                  t([["\u8d85\u6e05", v.replace("[[type]]", "hd")], ["\u9ad8\u6e05", v.replace("[[type]]", "mp4")], ["\u6807\u6e05", v.replace("[[type]]", "flv")]])
                } else {
                  var g = new l(c, c.stream, "mp4");
                  console.log(g._videoSegsDic.streams.guoyu)
                  console.log('每个Array里的每个object里的src，存着视频地址，可以把他复制出来直接在地址栏打开')
                  // t([["\u6807\u6e05", g._videoSegsDic.streams.guoyu["3gphd"][0].src]])
                }
              }
            })
          },
          ...
          c.prototype = {
            cg_hun: function() {
              this._cgStr = "";
              for (var e = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ/\\:._-1234567890",
              t = e.length,
              n = 0; t > n; n++) {
          ...
          l.prototype = {
            ...
            getVideoSrc: function(e, t, n, i, o, l, c) {
              ...
              x = d.segs[t].key; ("" == x || -1 == x) && (x = d.key2 + d.key1);
              var k = "";
